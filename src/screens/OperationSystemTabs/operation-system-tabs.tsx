      ...
      <div className="OperationSystemTab">
        <div className="WelcomeScreenSecond_first_part">
          ...
          <div className="tabs_cont">
            <div className={"one_tab tab_1 " + (selectedTab === Tab.Health ? "selected_tab_blue" : "")} onClick={() => setselectedTab(Tab.Health)}>
              <img src={status_icon} className="status_icon" />
              סטטוס</div>

            <div className={"one_tab tab_2 " + (selectedTab === Tab.Coins ? "selected_tab_blue" : "")} onClick={() => setselectedTab(Tab.Coins)}>
              <img src={coins_white} className="status_icon" />
              הטענות מטבעות</div>

            <div className={"one_tab tab_3 " + (selectedTab === Tab.Bills ? "selected_tab_blue" : "")} onClick={() => setselectedTab(Tab.Bills)}>
              <img src={banknotes_white} className="status_icon" />
              הטענות שטרות</div>

            <div className={"one_tab tab_4 " + (selectedTab === Tab.Report ? "selected_tab_4" : "")} onClick={() => setselectedTab(Tab.Report)}>
